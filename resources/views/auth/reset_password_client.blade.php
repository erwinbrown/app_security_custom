<x-layouts.main-layout pageTitle="Establecer Nueva Constraseña">
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-6">
                <p class="display-6">DEFINIR NOVA SENHA</p>

                <form action="{{ route('changes_password_verificado') }}" method="post">
                        @csrf

                        <input type="hidden" name="tokene" value="{{ $token }}">
